...
Most of these vulnerabilities can be automatically tested by [RsaCtfTool](https://github.com/Ganapati/RsaCtfTool), which tries most of the mentioned attacks given one or more public keys.
